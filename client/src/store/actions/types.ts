...
export const GET_USER_TOKEN_BALANCE = 'get-user-token-balance'; // used
export const GET_USER_TOTAL_BALANCE = 'get-user-total-balance'; //used

export const GET_ASSET_PRICES = 'get-asset-prices';
export const GET_NAME = 'get_name';
export const GET_CONTRIBUTION = 'get_contribution';
export const GET_INTEREST_RATE = 'get_interest_rate';
export const GET_INTEREST_RATES = 'get_interest_rates'; // used

export const LOAD_DEPOSIT = 'load-deposit';
export const DEPOSIT_FAIL = 'deposit-fail'; // used
